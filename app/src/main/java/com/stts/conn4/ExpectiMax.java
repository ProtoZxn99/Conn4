...
public class ExpectiMax {
    ...
    public ExpectiMax(int ai, int ply) {
        this.ai = ai;
        this.ply = ply;
    }
    ...
    public int findmove(Board b){
        Board best = AI(b);
        best.printboard();
        System.out.println("best move = "+best.move+" value = "+best.value);
        return best.move;
    }
    ...
    public int evaluate(Board b){
        ...
        try {
            ...
            Logger.getLogger(ExpectiMax.class.getName()).log(Level.SEVERE, null, ex);
        }
        if(losescore){
            losescore = false;
            return -2000000000;
